      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl p-8 mb-5">
          <div class="flex flex-col-reverse items-end md:flex-row md:items-center justify-between">
            <div class="text-3xl font-bold">Hello Dr. {data.name}</div>
            <button
              type="button"
              onClick={() => {
                signOut();
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-20">
            <div class="grid grid-cols-2 gap-4">
              ...
              <div class="p-4 bg-yellow-100 rounded-xl text-gray-800">
                ...
                <div class="mt-2">Patient Requests</div>
              </div>
              <div class="p-4 bg-yellow-100 rounded-xl text-gray-800">
                <div class="font-bold text-2xl leading-none">5</div>
                <div class="mt-2">5 Meets today</div>
              </div>
              <div class="col-span-2">
                <div class="p-4 bg-purple-100 rounded-xl text-gray-800">
                  ...
                  <div class="mt-2">0 of 10 completed</div>
                </div>
              </div>
            </div>
